...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 16777216 # This is the maximum known partition size, but it can be higher.
BOARD_BOOTIMAGE_PARTITION_SIZE := 16777216 # Exactly the same as recovery.
